 ...
 export function generatePDF(data) {
     return new Promise((resolve, reject) => {
         ...
         doc.font('Times-Roman')
            .fontSize(24)
            .text('Transportation-Demo application Finance Sheet', { align: 'center' });
 ...
 */
 ...
 export function generateBookingPDF(data) {
    return new Promise((resolve, reject) => {
        ...
        doc.font('Times-Roman')
           .fontSize(24)
           .text('Transportation-Demo application Booking Finance Sheet', { align: 'center' });
...
export function generateDeparturePDF(data) {
    return new Promise((resolve, reject) => {
        ...
        doc.font('Times-Roman')
           .fontSize(24)
           .text('Transportation-Demo application Departures Finance Sheet', { align: 'center' });
